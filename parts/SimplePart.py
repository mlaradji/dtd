...
#-----------------  
    ...
    def set_max_degree(self, max_degree):
        ...
        if type(max_degree) is int:
            ...
            raise TypeError('max_degree must be an integer. Received '+str(max_degree)+' instead.')
            
        return
    
 
    def set_end_vertex_degree(self, end_vertex_degree):
        '''
        Sets the end_vertex_degree of self. End vertices of parts are vertices that can be identified without exceeding the max_degree.
        
        The default end_vertex_degree is 2.
        '''
        
        if type(end_vertex_degree) is int:
            self.end_vertex_degree=end_vertex_degree
...
#----------------- 
    ...
    def external_vertices(self, present_edges='bare_skeleton'):
        '''
        # This function returns and IndexedSet of the external vertices of self.
