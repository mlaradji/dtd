...
#-----------------  
    ...
    def graph(self, present_edges='full'):
        ...
        #
        #   Options:
        #       present_edges -   str -   Passed to SimplePart.
        '''
        ...
        # Add the chord edges to the graph if the chord_vector is a property of self.
#         if present_edges is 'full':
#             try:
#                 graph.add_edges(self.chord_vector.chord_edges)
#             except:
#                 pass
